...
export const strings = {
  en: {
    ...
    'nav.rx': 'Prescription Assistance',
    'nav.rxFinder': 'Help Paying for Prescription Drugs',
    'nav.rxAll': 'All Medications',
    'nav.rxReview': 'Free Prescription Review',
    'nav.rxExtraHelp': 'Medicare Extra Help',
  ...
  es: {
    ...
    'nav.rx': 'Asistencia con recetas',
    'nav.rxFinder': 'Ayuda para pagar sus medicamentos',
    'nav.rxAll': 'Todos los medicamentos',
    'nav.rxReview': 'Revisión gratuita de recetas',
    'nav.rxExtraHelp': 'Ayuda Adicional de Medicare',
