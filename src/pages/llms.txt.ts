...
export const GET: APIRoute = async () => {
  ...
  sections.push(
    `# AltaMedicare`,
    ``,
    `> Independent, plain-English Medicare guidance for Utah from Bret Swope, a licensed local agent in Alpine, UT. Free help understanding Medicare and comparing Medicare Advantage, Medigap (Medicare Supplement), and Part D — plus interactive calculators. Phone: (435) 292-5548.`,
    ``,
