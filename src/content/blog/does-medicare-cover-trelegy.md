---
title: "Does Medicare Cover Trelegy?"
description: "Yes — Medicare Part D covers Trelegy for COPD and asthma. Here's how coverage works, why prior authorization is common, and what to check on your plan's formulary."
publishDate: 2026-06-08
updatedDate: 2026-06-08
author: "Bret Swope"
category: "drug-coverage"
featured: false
tags: ["Trelegy", "COPD", "asthma", "inhalers", "Part D"]
relatedTools: ["formulary", "drug-cost", "cost-estimator"]
faqs:
  - question: "Does Medicare Part D cover Trelegy?"
    answer: "Yes. Trelegy Ellipta is a self-administered maintenance inhaler, so it's covered under Medicare Part D. Because there's no generic version, it's usually placed on a brand-name tier, and many plans require prior authorization or step therapy first."
  - question: "Why does my plan want me to try another inhaler before Trelegy?"
    answer: "That's step therapy. Some plans ask you to try a preferred, often lower-cost inhaler first, and only cover Trelegy if that one doesn't work well enough for you. Your doctor can request an exception if there's a medical reason you need Trelegy."
  - question: "Is there a generic version of Trelegy?"
    answer: "No. Trelegy is brand-only right now, which is why it tends to land on a higher brand tier with a larger copay than an everyday generic."
  - question: "Will Medicare's drug price negotiation lower the cost of Trelegy?"
    answer: "Trelegy is in the second group of drugs Medicare negotiated a price for, with that negotiated price taking effect January 1, 2027. It lowers the underlying price, but what you actually pay still depends on your plan and tier."
---
