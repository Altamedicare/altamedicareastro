...
description: "Missing your Medicare enrollment window can mean lifetime late penalties and a coverage gap. Here's exactly what happens — and how to get back on track."
publishDate: 2026-02-17
updatedDate: 2026-02-17
author: "Bret Swope"
category: "turning-65"
featured: false
tags: ["late enrollment", "penalty", "GEP", "missed enrollment"]
relatedTools: ["penalty", "timeline"]
faqs:
  - question: "What is the General Enrollment Period?"
    answer: "The General Enrollment Period (GEP) runs January 1 through March 31 each year. It's the window to sign up for Medicare if you missed your Initial Enrollment Period, and your coverage starts the first of the month after you enroll."
  - question: "How much is the Part B late penalty?"
    answer: "The Part B late penalty adds 10% to your premium for each full 12 months you could have had Part B but didn't. It lasts the entire time you have Part B, so it never goes away."
  - question: "How is the Part D late penalty calculated?"
    answer: "The Part D penalty is 1% of the $38.99 national base premium for each full month you went without creditable drug coverage. It's added to your Part D premium permanently."
  - question: "Can I avoid the late penalty if I had insurance through work?"
    answer: "Often, yes. If you had active employer coverage from an employer with 20 or more employees, you get an 8-month Special Enrollment Period to sign up for Part B with no penalty. COBRA and retiree plans do not count."
---
...
| Penalty | How it's figured | How long it lasts |
|---|---|---|
| Part B | +10% of premium per full 12 months late | As long as you have Part B |
