---
title: "IRMAA Brackets Explained (2026)"
description: "IRMAA is the income surcharge added to Medicare Part B and Part D for higher earners. See the 2026 brackets, how the two-year lookback works, and how to appeal."
publishDate: 2026-01-15
updatedDate: 2026-01-15
author: "Bret Swope"
category: "costs"
featured: true
tags: ["IRMAA", "Part B", "Part D", "income", "2026 costs"]
relatedTools: ["irmaa", "cost-estimator"]
faqs:
  - question: "What is IRMAA?"
    answer: "IRMAA stands for Income-Related Monthly Adjustment Amount. It's an extra charge added to your Medicare Part B and Part D premiums when your modified adjusted gross income (MAGI) is above the annual threshold."
  - question: "What income is used to calculate IRMAA for 2026?"
    answer: "IRMAA uses a two-year lookback, so your 2026 surcharge is based on the modified adjusted gross income (MAGI) from your 2024 federal tax return — your adjusted gross income plus any tax-exempt interest."
  - question: "What are the 2026 IRMAA income thresholds?"
    answer: "IRMAA starts when 2024 MAGI is above $109,000 for a single filer or $218,000 for a married couple filing jointly. Below those amounts you pay the standard premium with no surcharge."
  - question: "Can I appeal or reduce my IRMAA?"
    answer: "Yes. If your income dropped because of a life-changing event such as retirement, divorce, or the death of a spouse, you can file Form SSA-44 with Social Security to have a more recent year's income used instead."
  - question: "Is IRMAA permanent?"
    answer: "No. IRMAA is recalculated every year based on your most recent tax return on file. If your income drops below the threshold, the surcharge goes away the following year."
---
...
1. **It's a cliff, not a ramp.** Go one dollar over a bracket and you pay the full surcharge for that bracket — there's no gradual phase-in.
2. **It looks back two years.** Your 2026 IRMAA is based on your **2024** income, because that's the most recent tax return the IRS has shared with Social Security.
