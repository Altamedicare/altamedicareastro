---
title: "Does Medicare Cover Trulicity?"
description: "Yes — Medicare Part D covers Trulicity when it's prescribed for type 2 diabetes. Here's how coverage, prior authorization, and step therapy typically work."
publishDate: 2026-06-09
updatedDate: 2026-06-09
author: "Bret Swope"
category: "drug-coverage"
featured: false
tags: ["Trulicity", "diabetes", "GLP-1", "Part D"]
relatedTools: ["formulary", "drug-cost", "cost-estimator"]
faqs:
  - question: "Does Medicare cover Trulicity?"
    answer: "Yes. Medicare Part D covers Trulicity when it's prescribed for type 2 diabetes, which is the use it's FDA-approved for. Coverage, tier, and rules vary by plan and change each year."
  - question: "Which part of Medicare covers Trulicity?"
    answer: "Trulicity is covered under Medicare Part D, the prescription drug benefit. That's either a standalone Part D plan paired with Original Medicare or the drug coverage built into a Medicare Advantage plan."
  - question: "Why does my plan require prior authorization for Trulicity?"
    answer: "Many Part D plans ask your doctor to confirm you're using Trulicity for an approved reason, such as type 2 diabetes, before they'll cover it. Prior authorization and step therapy are both common for this drug."
  - question: "Is there a generic version of Trulicity?"
    answer: "No. Trulicity is brand-only with no generic available, so it's usually placed on a brand or specialty tier. Your doctor can discuss other diabetes medicines if cost is a concern."
---
