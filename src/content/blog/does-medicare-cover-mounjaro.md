---
title: "Does Medicare Cover Mounjaro?"
description: "Medicare Part D covers Mounjaro for type 2 diabetes — but not for weight loss. Here's how coverage works and how it differs from Zepbound."
publishDate: 2026-06-10
updatedDate: 2026-06-10
author: "Bret Swope"
category: "drug-coverage"
featured: false
tags: ["Mounjaro", "diabetes", "tirzepatide", "GLP-1", "Part D"]
relatedTools: ["formulary", "drug-cost", "cost-estimator"]
faqs:
  - question: "Does Medicare cover Mounjaro for weight loss?"
    answer: "No. By law, Medicare cannot cover a drug used for weight loss. Mounjaro can be covered under Part D when it's prescribed for type 2 diabetes, but not when the goal is weight loss."
  - question: "What's the difference between Mounjaro and Zepbound?"
    answer: "They contain the same medicine, tirzepatide, but they're sold under different brand names for different uses. Mounjaro is approved for type 2 diabetes, while Zepbound is approved for weight management and sleep apnea. That difference in use is what determines Medicare coverage."
  - question: "Which part of Medicare covers Mounjaro?"
    answer: "Mounjaro is covered under Medicare Part D, the prescription drug benefit. That's either a standalone Part D plan paired with Original Medicare or the drug coverage built into a Medicare Advantage plan."
  - question: "Is there a generic version of Mounjaro?"
    answer: "Not yet. Mounjaro is brand-only with no generic available, so it usually sits on a brand or specialty tier on your plan's formulary."
---
